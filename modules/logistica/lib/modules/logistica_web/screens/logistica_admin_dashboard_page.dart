...
import '../controllers/logistica_dashboard_controller.dart';
...
class LogisticaAdminDashboardPage extends StatefulWidget {
  const LogisticaAdminDashboardPage({super.key});

  @override
  State<LogisticaAdminDashboardPage> createState() =>
      _LogisticaAdminDashboardPageState();
}

class _LogisticaAdminDashboardPageState
    extends State<LogisticaAdminDashboardPage> {
  late final LogisticaDashboardController controller;

  @override
  void initState() {
    super.initState();
    controller = LogisticaDashboardController()..carregar();
  }
...
class _DashboardBody extends StatelessWidget {
  final LogisticaDashboardData data;
  final bool busy;
